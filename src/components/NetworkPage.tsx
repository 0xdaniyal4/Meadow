...
import { Network, Server, ShieldCheck, Activity, Cpu, Database, CheckCircle2, Search, Wallet, AlertCircle } from 'lucide-react';
...
export const NetworkPage: React.FC = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    // Gating check
    if (!walletActive) {
      setErrorMessage('Please connect your wallet first to query Shelby Protocol network blobs.');
      return;
    }
    ...
    setSearchResult({
      ...
      size: '2.4 MB',
      createdAt: 'Shelbynet Block #184,920,411',
      consensus: 'Shelbynet Testnet Proof of Stake'
    });
  };
    ...
    <div className="w-full min-h-screen pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
      ...
      <div>
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#66F4FF]/30 bg-[#66F4FF]/10 text-[#66F4FF] text-xs font-mono font-semibold mb-3">
          ...
          SHELBY PROTOCOL NETWORK INFRASTRUCTURE
        </div>
        <h1 className="text-3xl font-extrabold text-[#cae7f9]">Shelby Protocol Network</h1>
        <p className="text-base text-[#bec8d1] mt-1">
          Real-time decentralized storage node status and Shelbynet Testnet network state.
        </p>
      </div>

      {/* Wallet Gating when NOT connected */}
      {!walletActive ? (
        <div className="glass-panel rounded-2xl p-10 border border-[#66F4FF]/30 bg-[#032330] text-center space-y-5 max-w-xl mx-auto glow-aqua">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-[#bec8d1] leading-relaxed">
              Shelby Protocol network metrics and decentralized storage cluster statuses are gated to authenticated Web3 wallet accounts on Shelbynet Testnet.
            </p>
          </div>
          <button
          ...
          >
            ...
            <span>Connect Wallet to Access Network Data</span>
          </button>
        </div>
      ) : (
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div className="glass-panel rounded-2xl p-5 border border-white/10 bg-[#032330]">
              ...
              <div className="text-2xl font-black text-[#cae7f9]">Shelbynet Testnet</div>
          ...
          <div className="glass-panel rounded-2xl p-6 border border-white/10 bg-[#032330] space-y-4">
            ...
            <p className="text-sm text-[#bec8d1]">
              Query any Shelby Blob ID or transaction hash on Shelbynet Testnet to inspect replication parameters.
            </p>
            ...
            {searchResult && (
              <div className="mt-4 p-5 rounded-xl bg-[#001620] border border-[#66F4FF]/30 font-mono text-xs space-y-2 text-[#cae7f9]">
                ...
                <div className="flex justify-between">
                  <span className="text-[#bec8d1]">SHELBYNET PROOF:</span>
          ...
          <div className="glass-panel rounded-2xl p-6 border border-white/10 bg-[#032330] space-y-4">
            <h2 className="text-xl font-bold text-[#cae7f9]">Active Shelby Node Clusters (Shelbynet Testnet)</h2>
